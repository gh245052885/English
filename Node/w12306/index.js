...
function queryTickets(config) {
    var options = {
        ...
        path: '/otn/leftTicket/queryA?leftTicketDTO.train_date=' + config.time + '&leftTicketDTO.from_station=' + config.from_station
        ...
        res.on('end', function () {
            ...
            for (var i = 0; i < jsonData.length; i++) {
                ...
                if (true) {
                    ...
                    logger.info("cur:" + cur.queryLeftNewDTO.canWebBuy);
                } else {
